    ...
    internal class ArticleRepository
    {
        ...
        static ArticleRepository()
        {
            articles = new List<Article>
            {
                ...
                {
                   Id=10,
                   Title = @"2-Git远程：push / pull / clone / fetch / conflict",
                ...
                {
                   Id=15,
                   Title = @"3-Git远程：push / pull / clone / fetch / conflict",
                   Body = @"注意，之前所有操作，都是在本地（你自己的电脑上）进行的。要想和别人分享看到你的代码，你需要： PS：2019之前的版本需要在github上手动建立一个，然后再从VS同步到远程仓库（略） 然后，在Visual Studio上为什么是clone？要想在两个仓库之间同步，仓库和仓库之间必须“基因”相同的。怎么才能相同呢？以下情形任选其一：A仓库是从B仓库clone的A仓库向一个从未被使用过的（bare，不是empty）B仓库推送同步（sync）同步会首先比较远程repository和本地repository ……",
                   Author = new User
                   {
                     Id = 25,
                ...
                {
                   Id=21,
                   Title = @"4-Git远程：push / pull / clone / fetch / conflict",
                   Body = @"注意，之前所有操作，都是在本地（你自己的电脑上）进行的。要想和别人分享看到你的代码，你需要： PS：2019之前的版本需要在github上手动建立一个，然后再从VS同步到远程仓库（略） 然后，在Visual Studio上为什么是clone？要想在两个仓库之间同步，仓库和仓库之间必须“基因”相同的。怎么才能相同呢？以下情形任选其一：A仓库是从B仓库clone的A仓库向一个从未被使用过的（bare，不是empty）B仓库推送同步（sync）同步会首先比较远程repository和本地repository ……",
                   Author = new User
                   {
                     Id = 25,
                ...
                {
                   Id=8,
                   Title = @"5-Git远程：push / pull / clone / fetch / conflict",
                   Body = @"注意，之前所有操作，都是在本地（你自己的电脑上）进行的。要想和别人分享看到你的代码，你需要： PS：2019之前的版本需要在github上手动建立一个，然后再从VS同步到远程仓库（略） 然后，在Visual Studio上为什么是clone？要想在两个仓库之间同步，仓库和仓库之间必须“基因”相同的。怎么才能相同呢？以下情形任选其一：A仓库是从B仓库clone的A仓库向一个从未被使用过的（bare，不是empty）B仓库推送同步（sync）同步会首先比较远程repository和本地repository ……",
                   Author = new User
                   {
                     Id = 25,
                ...
                {
                   Id=14,
                   Title = @"6-Git远程：push / pull / clone / fetch / conflict",
                   Body = @"注意，之前所有操作，都是在本地（你自己的电脑上）进行的。要想和别人分享看到你的代码，你需要： PS：2019之前的版本需要在github上手动建立一个，然后再从VS同步到远程仓库（略） 然后，在Visual Studio上为什么是clone？要想在两个仓库之间同步，仓库和仓库之间必须“基因”相同的。怎么才能相同呢？以下情形任选其一：A仓库是从B仓库clone的A仓库向一个从未被使用过的（bare，不是empty）B仓库推送同步（sync）同步会首先比较远程repository和本地repository ……",
                   Author = new User
                   {
                     Id = 25,
                ...
                {
                   Id=6,
                   Title = @"7-Git远程：push / pull / clone / fetch / conflict",
                   Body = @"注意，之前所有操作，都是在本地（你自己的电脑上）进行的。要想和别人分享看到你的代码，你需要： PS：2019之前的版本需要在github上手动建立一个，然后再从VS同步到远程仓库（略） 然后，在Visual Studio上为什么是clone？要想在两个仓库之间同步，仓库和仓库之间必须“基因”相同的。怎么才能相同呢？以下情形任选其一：A仓库是从B仓库clone的A仓库向一个从未被使用过的（bare，不是empty）B仓库推送同步（sync）同步会首先比较远程repository和本地repository ……",
                   Author = new User
                   {
                     Id = 25,
