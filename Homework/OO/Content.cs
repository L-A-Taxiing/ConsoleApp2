...
{    internal abstract class Content         //思考之前的Content类，该将其抽象成抽象类还是接口？为什么？并按你的想法实现。
    {
        ...
        public Content(string _kind, DateTime CreateTime)         // 确保每个Content对象都有kind的非空值
        {
        ...
        private DateTime CreateTime { get; }//Content中的createTime，不能被子类使用，但只读属性PublishTime使用它为外部提供内容的发布时间
